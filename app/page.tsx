...
// Concentric rings SVG logo — canonical brand mark
function ConcentricRingsLogo({ size = 32 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" fill="none" aria-label="DR MAGfield">
      <circle cx="20" cy="20" r="18" fill="none" stroke="#C9A96E" strokeWidth="1.5" opacity="0.4" />
      <circle cx="20" cy="20" r="13" fill="none" stroke="#C9A96E" strokeWidth="1.5" opacity="0.65" />
...
// Stitch canonical image URLs (from project DR MAGfield V3 Iter3)
const GOLF_COURSE_IMG = 'https://lh3.googleusercontent.com/aida-public/AB6AXuB8kBVbvzNPWuksDawBGvtjsTUEaQZhNhIU1V2NAtUmbDv_z9Bs96Iesy6xXbtNShEgDwTCjhUroZ5arFiukfno-i0GJF-sxTkRiGsgJ-5-e1S5zSY0lDHCu9rkIy3OpfkeSUXC1xJRvm6Nby-2Qf8PhzkLvib8aPogJIDRcg-rgAEV-P5YKEcixuxc9G3AvYeTbXbW2UBwiWvBHytdOvtC741bd5H4QzBhITe0Nb7PV10u8A2giEPbHjB_hEXBv_4IiIWtsxlHztc'
const QI_MASTER_IMG = 'https://lh3.googleusercontent.com/aida-public/AB6AXuCHTXX2l9QHz1cOn7UHGlbcEH9MZ0OmbTyTIwxzN3pT5WcJ6eBuM100odSx77k3fWGPPx2AIc_ZjWKjm0eiNGCCJA1RbkL2brxhhPS6DLbWg4qEtc7MUF6ACPHB6R6C45ye9KfiZw_U31fNHsl02ohwVmuCji3wK47iFqFjbHyxblIl9NsuApZc8ELxkI7pU1AOwLxp4rwJQLMEAuIiQ3CHuukyc2jCxJ5z718lVgvyGv-vS73LJIwWAT0n5Qg9VvjuybbjN5WdzQ4'
const QI_MINI_IMG = 'https://lh3.googleusercontent.com/aida-public/AB6AXuCqftQgtrv8PZQAVCpdZtbrEDYAr22vnkV0nYSpIhn2p6OaCL9VjQVqtsT8kvPkXypUm7G-QUM851XEyQ6rGfQdItf067CKLmIphR-ahcUQZbtA6jvTpNt25568Q3GAw7VMpDV05nLp2-thgwa1MT3rjARUJ5CBPj4u2VDwZZs2mVxL1Nf8lY0ZxelnDyHzR6RTqAcTcy18QPfCPgzFfsgw_8avDPcbq9n2Dxid-B_mtptDNLveQuwRvFPNs1pwEkTPu5KH9gKAm00'
...
const KRPM_MAP_IMG = 'https://lh3.googleusercontent.com/aida-public/AB6AXuAk_UV27NgpIvnvwdljCl89HeAUxq8HNjkDRPR1iDxyOdT3E4pQaRCTGDs5SSyY7wwRYqMY_uAdlsJP7NDJ8EPrZCw0j3EniJyXtSdBckN4msV3UkULFsMt_BFHLtAxW4tqT-kCZ8PnpXlA3LazcVD5MMGKR25mpBUg_Ex_ktdEv3ATuwe_-eZ7g7L_CjOx8wGu2vePLqZPvAVyGWlgL2O6qwzNoM8ACON6l6l5pdUKRFlsHcr7dQGc-pQx4vqUamFOPCl4qUhDs_I'
    ...
    <div className="pwa-container">
      ...
      <section className="hero">
        <div className="hero-bg">
          ...
          <img src={GOLF_COURSE_IMG} alt="KRPM Golf Course at sunrise" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 48 }}>
          ...
          <div>
            <div style={{ position: 'relative', borderRadius: '1.5rem', overflow: 'hidden', aspectRatio: '4/5', marginBottom: 20 }}>
              ...
              <div style={{ position: 'absolute', right: -1, top: '50%', transform: 'translateY(-50%) rotate(90deg), origin: right center', background: '#182232', color: '#C9A96E', padding: '8px 20px', fontFamily: 'Montserrat, sans-serif', fontSize: '10px', fontWeight: 700, letterSpacing: '0.25em' }}>
                QI MASTER
              </div>
            </div>
      ...
      <section className="location-section" id="location">
        ...
        <div style={{ borderRadius: '1rem', overflow: 'hidden', aspectRatio: '16/9', marginBottom: 20, filter: 'grayscale(30%)' }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={KRPM_MAP_IMG} alt="KRPM Location Map" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
